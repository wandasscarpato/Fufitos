...
/*Arrays------------------------------------*/
const dulce=[ "Cupcakes OREO", "Torta mouse de OREO", "Cheesecake", "Alfajores bomba","Carrot cake","Cupcakes glaseados"];
const salado=["Pizza", "Empanadas", "Canapés", "Miga", "Bocaditos","Medialunas"];
const extra=["Dessert Cups","Dragon Fruit Panna","Dessert Shooters","Meyer Lemon Parfaits","Dessert Shooters","Cheesecake parfaits","cheesecake caramel"];
